														   ...
														   if ( hkill == 61 )
														   {
														    ...
														    for ( int a_S40=start[61] ; a_S40 < upper ; a_S40++ )
														    {
														     ...
														     if ( hkill == 62 )
														     {
														      ...
														      for ( int a_S41=start[62] ; a_S41 < upper ; a_S41++)
														      {
														       if (!( a_S41 < upper ) && ( prime[62] == 0 )){
														        prime[62]=1;
															a_S41=lo;
														       }
														       if ( hkill == 63 )
														       {
															printf("%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n",a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aA,aB,aC,aD,aE,aF,aG,aH,aI,aJ,aK,aL,aM,aN,aO,aP,aQ,aR,aS,aT,aU,aV,aW,aX,aY,aZ,a_S126,a_S33,a_S64,a_S35,a_S36,a_S37,a_S94,a_S38,a_S42,a_S40,a_S41);
														       }
														       else {
															for ( int a_S95=start[63]; a_S95 < upper ; a_S95++)
															{
															 if (!( a_S95 < upper ) && ( prime[63] == 0))
															 {
															  prime[63]=1;
															  a_S95=lo;
															 }
															 if ( hkill == 64 )
															 {
															  printf("%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n",a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aA,aB,aC,aD,aE,aF,aG,aH,aI,aJ,aK,aL,aM,aN,aO,aP,aQ,aR,aS,aT,aU,aV,aW,aX,aY,aZ,a_S126,a_S33,a_S64,a_S35,a_S36,a_S37,a_S94,a_S38,a_S42,a_S40,a_S41,a_S95);
															 }
															 //here
															}
														       }
														       /*ignore 3-24-2017 @ 10:45am*///here
														      }
														     }
														     /*ignore 3-24-2017 @ 10:40 am*///here
														    }
														   }
