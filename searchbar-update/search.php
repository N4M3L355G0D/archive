...
if($con->connect_error){
	...
	$logH=$logosize[1]/2;
echo "<body>";
echo "<div style='position: fixed; background-color: black; width: 100%; z-index: 999; opacity: 100%;'>";
			  ...
			  <table>
			   <tr>
				...
				Image ID
			      ...
			      <tr>
			       <td><div class='tooltip'><a download='".basename($path)."' href='".$path." 'alt='".$path."'>Download</a><span class='tooltiptext'>Download</span></div></td>
			      </tr>
			      <tr>
